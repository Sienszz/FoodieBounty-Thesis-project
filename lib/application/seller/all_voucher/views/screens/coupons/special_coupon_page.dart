...
class SpecialCouponPage extends GetView<AllVoucherController> {
    ...
    return Obx(() => controller.isLoading.isTrue ? 
      ...
      ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          if(controller.lsVoucher[index].type! == 'special' && 
                    ...
                    widget: Row(
                      ...
                      children: [
                        cardWidget.DescText(title: 'Kuantitas',
                          subtitle: controller.lsVoucher[index].qty == null ? "-" :
                          controller.lsVoucher[index].qty!.toString()),
                        ElevatedButton(
