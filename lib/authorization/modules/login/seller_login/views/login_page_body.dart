...
import 'package:projek_skripsi/authorization/modules/login/seller_login/views/widgets/dialog_widget.dart';
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
                onTap: () => DialogWidget().forgetPassword(controller: controller),
                child: Text(
                  'Lupa Kata Sandi?',
